...
<html>
  <head>
    ...
    <title>RPL Learning | Kelola Mata Kuliah</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-files-o"></i> Pengelolaan Mata Kuliah</li>
                  ...
                  <div class="box-body">
                    <form role="form" method="post" action="admin.php">
                        <div class="form-group">
                          <label>ID</label>
                          <input type="text" class="form-control" placeholder="ID tidak bisa di edit" disabled="true" value="<?php echo $_SESSION['editmk_id']; ?>">
                        </div>
                        <div class="form-group">
                          <label>Nama Mata Kuliah</label>
                          <input type="text" class="form-control" name="nama_matkul" placeholder="Masukkan nama mata kuliah" value="<?php echo $_SESSION['editmk_nama']; ?>">
                        </div>
                      </div><!-- /.box-body -->
                      <div class="box-footer">
                        <a href="kelola_matkul.php"><span class="btn btn-default">Kembali</span> </a>
                        <input type="hidden" name="id" value="<?php echo $_SESSION['editmk_id']; ?>">
                        <button type="submit" class="btn btn-danger pull-right" name="update_matkul">Edit</button>
                      </div>
                    </form>
              </div><!-- /.box -->
            </div>
              ...
              <div class="box box-danger">
                  ...
                  <div class="box-body">
                    <table id="userdata" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php while($row = $matkul_list->fetch_assoc()): ?><tr>
                          <th><?php echo $row['id']; ?></th>
                          <th><?php echo $row['namamatkul']; ?></th>
                          <th>
                            <form role="form" method="post" action="admin.php" class="noline">
                              <input type="hidden" name="id_matkul" value="<?php echo $row['id']; ?>">
                              <input type="hidden" name="nama_matkul" value="<?php echo $row['namamatkul']; ?>">
                              <button type="submit" class="btn btn-info" name="edit_matkul"><i class="fa fa-edit"></i></button>
                            </form>
                            <form role="form" method="post" action="admin.php" class="noline">
                              <input type="hidden" name="id_matkul" value="<?php echo $row['id'] ?>">
                              <button type="submit" class="btn btn-danger" name="delete_matkul"><i class="fa fa-trash"></i></button>
                                    </form>
                                  </th>
                                </tr>
                      <?php endwhile; ?></tbody>
