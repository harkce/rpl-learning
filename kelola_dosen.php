        	...
        	<div class="row">
        		<div class="col-lg-6">
        			<div class="box box-danger">
                        ...
                        <div class="form-group">
                          <label>NIP</label>
                          <input type="number" min="10000000000" max="99999999999" class="form-control" name="nip" placeholder="Masukkan NIP">
                        </div>
				                <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select name="matkul" class="form-control" placeholder="Pilih mata kuliah">
                            ...
                            <?php $matkul_list = getMatkulList(); 
                              while($row = $matkul_list->fetch_assoc()): ?><option value="<?php echo $row['id']; ?>"><?php echo $row['namamatkul']; ?></option>
                          <?php endwhile; ?></select>
                        </div>
				              <div class="box-footer">
				              	<button type="submit" class="btn btn-danger pull-right" name="insert_dosen">Tambah</button>
				              </div>
			              </form>
			            </div><!-- /.box-body -->
			        </div><!-- /.box -->
