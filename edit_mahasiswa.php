        	...
        	<div class="row">
        		<div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label>ID</label>
                      <input disabled type="text" class="form-control" placeholder="ID tidak dapat diedit" value="<?php echo $_SESSION['editmhs_id']; ?>">
                    </div>
			          		<div class="form-group">
                      <label>Nama Lengkap</label>
                      <input type="text" class="form-control" name="fullname" placeholder="Masukkan nama lengkap" value="<?php echo $_SESSION['editmhs_fullname']; ?>">
                    </div>
                    <div class="form-group">
                      <label>NIM</label>
                      <input type="number" min="1000000000" max="9999999999" class="form-control" name="nim" placeholder="Masukkan NIM" value="<?php echo $_SESSION['editmhs_nim']; ?>">
                    </div>
                    <div class="form-group">
                      <label>Username</label>
                      <input type="text" class="form-control" value="<?php echo $_SESSION['editmhs_username']; ?>" placeholder="Username untuk login">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="kelas" class="form-control" placeholder="Pilih mata kuliah">
                        ...
                        <?php $kelas_list = getKelasList(); while($row = $kelas_list->fetch_assoc()): ?><option <?php if ($row['id'] == $_SESSION['editmhs_kls']) echo "selected"; ?> value="<?php echo $row['id']; ?>"><?php echo $row['namakelas']; ?></option>
                      <?php endwhile; ?></select>
                    </div>
				            <div class="box-footer">
                      <input type="hidden" name="id" value="<?php echo $_SESSION['editmhs_id']; ?>">
				              <button type="submit" class="btn btn-danger pull-right" name="update_mahasiswa">Update</button>
				            </div>
			            </form>
			          </div><!-- /.box-body -->
			        </div><!-- /.box -->
