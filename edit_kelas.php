...
<html>
  <head>
    ...
    <title>RPL Learning | Kelola Kelas</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-files-o"></i> Pengelolaan Kelas</li>
        		...
        		<div class="col-lg-6">
        			<div class="box box-danger">
			            ...
			            <div class="box-body">
                          ...
                          <label>ID</label>
                          <input disabled type="text" class="form-control" placeholder="ID tidak dapat diedit" value="<?php echo $_SESSION['editkelas_id']; ?>">
                        </div>
                        <div class="form-group">
			            				<label>Nama Kelas</label>
			            				<input type="text" class="form-control" name="nama_kelas" placeholder="Masukkan nama kelas" value="<?php echo $_SESSION['editkelas_nama']; ?>">
			                  </div>
				              <div class="box-footer">
				                <a href="kelola_kelas.php"><span class="btn btn-default">Kembali</span> </a>
                        <input type="hidden" name="id" value="<?php echo $_SESSION['editkelas_id']; ?>">
                        <button type="submit" class="btn btn-danger pull-right" name="update_kelas">Update</button>
				              </div>
			              </form>
			            </div><!-- /.box-body -->
			        </div><!-- /.box -->
        			...
        			<div class="box box-danger">
			            ...
			            <div class="box-body">
			            	<table id="userdata" class="table table-bordered table-striped">
			            		...
			            		<tbody>
			            			<?php while($row = $kelas_list->fetch_assoc()): ?><tr>
			            				<th><?php echo $row['id']; ?></th>
			            				<th><?php echo $row['namakelas']; ?></th>
			            				<th>
			            					<form role="form" method="post" action="admin.php" class="noline">
			            						<input type="hidden" name="id_kelas" value="<?php echo $row['id']; ?>">
			            						<input type="hidden" name="nama_kelas" value="<?php echo $row['namakelas']; ?>">
			            						<button type="submit" class="btn btn-info" name="edit_kelas"><i class="fa fa-edit"></i></button>
			            					</form>
			            					<form role="form" method="post" action="admin.php" class="noline">
			            						<input type="hidden" name="id_kelas" value="<?php echo $row['id'] ?>">
				            					<button type="submit" class="btn btn-danger" name="delete_kelas"><i class="fa fa-trash"></i></button>
                          					</form>
                          				</th>
                          			</tr>
			            		<?php endwhile; ?></tbody>
