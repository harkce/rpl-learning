...
if (!isset($_SESSION['editdosen_id'])) {
...
<html>
  <head>
    ...
    <title>RPL Learning | Kelola Dosen</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="kelola_dosen.php"><i class="fa fa-circle-o"></i> Dosen</a></li>
        		...
        		<div class="col-lg-6">
        			<div class="box box-danger">
			            ...
			            <div class="box-body">
                          ...
                          <label>ID</label>
                          <input disabled="true" type="text" class="form-control" placeholder="ID tidak boleh diedit" value="<?php echo $_SESSION['editdosen_id']; ?>">
                        </div>
                        <div class="form-group">
			            				<label>Nama Lengkap</label>
			            				<input name="fullname" type="text" class="form-control" placeholder="Masukkan nama lengkap" value="<?php echo $_SESSION['editdosen_nama']; ?>">
			                  </div>
                        <div class="form-group">
                          <label>NIP</label>
                          <input name="nip" type="number" min="10000000000" max="99999999999" class="form-control" name="nip" placeholder="Masukkan 11 digit NIP" value="<?php echo $_SESSION['editdosen_nip']; ?>">
                        </div>
				                <div class="form-group">
				                 	<label>Username</label>
				                 	<input disabled="true" type="text" class="form-control" placeholder="Username tidak boleh diedit" value="<?php echo $_SESSION['editdosen_user']; ?>">
				                </div>
				                <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select name="matkul" class="form-control" placeholder="Pilih mata kuliah">
                            <option value="x">Pilih mata kuliah</option>
                            <?php $matkul_list = getMatkulList(); 
                              while($row = $matkul_list->fetch_assoc()): ?><option <?php if ($row['id'] == $_SESSION['editdosen_idmatkul']) echo "selected"; ?> value="<?php echo $row['id']; ?>"><?php echo $row['namamatkul']; ?></option>
                          <?php endwhile; ?></select>
                        </div>
				              <div class="box-footer">
                        <a href="kelola_dosen.php"><span class="btn btn-default">Kembali</span> </a>
                        <input type="hidden" name="id" value="<?php echo $_SESSION['editdosen_id']; ?>">
                        <button type="submit" class="btn btn-danger pull-right" name="update_dosen">Update</button>
                      </div>
			              </form>
			            </div><!-- /.box-body -->
			        </div><!-- /.box -->
        			...
        			<div class="box box-danger">
			            ...
			            <div class="box-body">
			            	<table id="userdata" class="table table-bordered table-striped">
			            		...
			            		<tbody>
			            			<?php while($row = $dosen_list->fetch_assoc()): ?><tr>
                            ...
                            <form role="form" method="post" action="admin.php" class="noline">
                              ...
                              <input type="hidden" name="id_matkul" value="<?php echo $row['dosenmatkul']; ?>">
                              <button type="submit" class="btn btn-info" name="edit_dosen"><i class="fa fa-edit"></i></button>
                            </form>
                            <form role="form" method="post" action="admin.php" class="noline">
