...
<html>
  <head>
    ...
    <title>RPL Learning | Kelola Admin</title>
                    ...
                    <form role="form" method="post" action="admin.php">
                      <div class="box-body">
                        <div class="form-group">
                          <label>ID</label>
                          <input disabled="true" type="text" class="form-control" placeholder="ID" value="<?php echo $_SESSION['edit_id']; ?>">
                        </div>
                        <div class="form-group">
                          <label>Nama Lengkap</label>
                          <input type="text" class="form-control" name="fullname" placeholder="Masukkan nama lengkap" value="<?php echo $_SESSION['edit_fullname']; ?>">
                        </div>
                        <div class="form-group">
                          <label>Username</label>
                          <input disabled="true" type="text" class="form-control" placeholder="Username untuk login" value="<?php echo $_SESSION['edit_username']; ?>">
                        </div>
                        <div class="form-group">
                      ...
                      <div class="box-footer">
                        ...
                        <a href="kelola_admin.php"><span class="btn btn-default">Kembali</span> </a>
              ...
              <div class="box box-danger">
                  ...
                  <div class="box-body">
                    <table id="userdata" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php while($row = $admin_list->fetch_assoc()): ?><tr>
                          ...
                          <th>
                            <form role="form" method="post" action="admin.php" class="noline">
                              ...
                              <button type="submit" class="btn btn-info" name="edit_user"><i class="fa fa-edit"></i></button>
                            </form>
                            <form role="form" method="post" action="admin.php" class="noline">
